...
export default class IssueNarrower extends DefaultModule<TypedPipelineModule<'NARROW_ISSUE'>> {
  ...
  private create_CTA_components(clarification_query: string): {
    ...
    embed.setFooter({
      text: `This message was generated by AI based on prompts configured by the server administrator. Its content does not represent the views of Thread-Watcher or Mistral AI.`,
    });
