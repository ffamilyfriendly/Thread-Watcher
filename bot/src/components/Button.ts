...
const ButtonInteractionQueue: Map<string, TwButton> = new Map<string, TwButton>()
...
export default class TwButton implements TwGenericComponent<ButtonInteraction> {
    ...
    constructor(label: string, style: ButtonStyle, misc?: { disabled?: boolean, emoji?: ComponentEmojiResolvable, url?: string }) {
