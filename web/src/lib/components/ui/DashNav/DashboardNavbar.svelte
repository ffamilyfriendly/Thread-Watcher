<script lang="ts">
	...
	import { ArrowDownRight, GitBranch, Indent, IndentIncrease, LucideBowArrow } from '@lucide/svelte';
...
<NavbarV2 width="250px" overlay={overlay} is_expanded={should_be_open}>
	{@render hamburger()}
